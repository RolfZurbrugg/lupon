...
def modify_contact(contact_id):
    ...
    location = Location.query.filter_by(contact_id=contact_id)
    locationform = LocationForm(location)
    ...
    return render_template('contact/modify_contact.html', contactform=contactform, contacts=contacts, locationform=locationform)
